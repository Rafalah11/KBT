...
Route::get('/edit/{id}', [lapanganadminController::class, 'edit'])->name('admin.editform')->middleware('UserAkses:ADMIN');
Route::put('/update/{id}', [lapanganadminController::class, 'update'])->name('update.form')->middleware('UserAkses:ADMIN');
Route::delete('/lapangan/{id}', [lapanganadminController::class,'destroy'])->name('lapangan.destroy')->middleware('UserAkses:ADMIN');;

Route::get('/form/{provinsi_id}', [kabupatencontroller::class, 'getKabupaten1'])->middleware('UserAkses:ADMIN');;
Route::get('/form', [kabupatencontroller::class, 'index'])->middleware('UserAkses:ADMIN');;
...
Route::get('/getKabupaten/{id_provinsi}', [kabupatenController::class, 'getKabupatenByProvinsi'])->middleware('UserAkses:ADMIN');;
Route::get('/getKabupatenn/{id_provinsi}', [kabupatenController::class, 'getKabupatenByProvinsi'])->middleware('UserAkses:ADMIN');;
...
Route::middleware(['auth', 'checkrole:ADMIN'])->group(function () {
    Route::get('/form', [lapanganadminController::class, 'form'])->name('form')->middleware('UserAkses:ADMIN');
    Route::post('/form', [lapanganadminController::class, 'store'])->name('form')->middleware('UserAkses:ADMIN');
});
